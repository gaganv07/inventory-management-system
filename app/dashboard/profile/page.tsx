...
export default function ProfilePage() {
  const [profile, setProfile] = useState({
    name: "Admin User", email: "admin@demo.com", phone: "+91 98765 43210",
    company: "IndusTrack Pvt. Ltd.", role: "ADMIN", bio: "System administrator managing the complete inventory platform.",
  });
